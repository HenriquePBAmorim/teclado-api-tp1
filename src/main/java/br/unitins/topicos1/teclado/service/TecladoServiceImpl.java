...
public class TecladoServiceImpl implements TecladoService {
    ...
    @Inject TecladoRepository repository;
    @Inject ModeloRepository modeloRepository;
    @Inject SwitchRepository switchRepository;
    @Inject KeycapRepository keycapRepository;
    ...
    @Override
    public TecladoDTOResponse findById(Long id) {
    ...
    @Override
    @Transactional
    public TecladoDTOResponse create(@Valid TecladoDTO dto) {
    ...
    @Override
    @Transactional
    public void update(Long id, @Valid TecladoDTO dto) {
    ...
    private void vincularAssociacoes(Teclado teclado, TecladoDTO dto) {
        ...
        if (dto.idAcessorios() != null) {
            for (Long idAces : dto.idAcessorios()) {
                ...
                if (aces == null) throw new NotFoundException("Acessório ID " + idAces + " não encontrada.");
